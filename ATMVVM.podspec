#
# Be sure to run `pod lib lint ATMVVM.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ATMVVM'
  s.version          = '0.1.2'
  s.summary          = 'A short description of ATMVVM.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/abiaoyo/ATMVVM'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'abiaoyo' => '347991555@qq.com' }
  s.source           = { :git => 'https://github.com/abiaoyo/ATMVVM.git', :tag => s.version.to_s }
